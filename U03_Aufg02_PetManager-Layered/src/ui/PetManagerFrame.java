...
import ui.model.JobListModel;
import ui.model.PeopleTableModel;
import ui.model.PetsTableModel;
...
public class PetManagerFrame extends JFrame {
	...
	public PetManagerFrame(PeopleList peopleList) {
		super();
	...
	private JTable getPeopleTable() {
		if (peopleTable == null) {
			PeopleTableModel model = new PeopleTableModel(peopleList);
			...
			JComboBox<String> comboBox = new JComboBox<>(new JobListModel());
		...
		if (addPersonButton == null) {
			...
			addPersonButton.addActionListener(new AbstractAction() {
				...
				public void actionPerformed(ActionEvent evt) {
					peopleList.addPerson(new Person("", ""));
		...
		public void actionPerformed(ActionEvent evt) {
			if (petsTable.getSelectedRowCount() > 0) {
				...
				PeopleTableModel peopleModel = (PeopleTableModel) peopleTable
						.getModel();
				Person person = peopleList.getPersonAt(modelSelectedRow);
